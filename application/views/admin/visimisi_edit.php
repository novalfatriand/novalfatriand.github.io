...
<div class="box">
        ...
        <div class="box-body">
            ...
            <input type="hidden" name="id" value="<?php echo $row->id ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="id_kandidat" id="id_kandidat" class="form-control">
                        <?php foreach ($kandidat as $knd) : ?>
                            <option value="<?php echo $knd->id ?>" <?php echo $row->id_kandidat == $knd->id ? 'selected' : '' ?>>
                            <?php echo $knd->nama_kandidat ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <a href="<?php echo site_url('admin/visi_misi'); ?>"class="btn btn-info">
